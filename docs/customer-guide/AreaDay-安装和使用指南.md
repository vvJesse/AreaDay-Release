...
**适用版本：AreaDay v1.1.0**　｜　更新日期：2026-09-13
...
然后把随购买获得的许可证文件直接拖入输入框。确认上面的文字和许可证文件已经放在同一条消息中，再点击“发送”。
...
看到 `license_valid`，表示 AreaDay 已经安装并激活成功。
...
论文、提取后的文本、词表、简报和学习记录保存在本地。词表校准服务只接收生成个人词表所需的单词统计信息和单词识别答案，不接收论文原文、PDF、来源网址或本地文件路径。
